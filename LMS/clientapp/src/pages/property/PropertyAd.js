...
const PropertyAd = ({ setShowMessage }) => {
  ...
  const handleLocation = (event, value) => {
    dispatch(
      setSelectedPosition({
        positionDetails: { lat: value.Lat, lng: value.Long, LocationName: value.LocationName, LocationId: value.LocationId }
      })
    );
  };
        ...
        <Grid container spacing={3}>
                ...
                startAdornment={
                  <InputAdornment>
                    <RemoveOutlinedIcon
                      aria-label="toggle password visibility"
                      onClick={() => {
                        parseInt(formik.values.Bathrooms) >= 1
                          ? formik.setFieldValue('Bathrooms', parseInt(formik.values.Bathrooms) - 1)
                          : 0;
                      }}
                      onMouseDown={handleMouseDownPassword}
                    ></RemoveOutlinedIcon>
          ...
          <Grid item xs={12} lg={5}>
            <Stack spacing={1}>
              ...
              <ToggleButtonGroup
                ...
                selections
              >
                <ToggleButton size="small" name="AvailableFor" color="success" value="1">
                  Only Family
                </ToggleButton>
                <ToggleButton size="small" name="AvailableFor" color="info" value="2">
                  All
                </ToggleButton>
              </ToggleButtonGroup>
          ...
          <Grid item xs={12} lg={10}>
            <Stack spacing={1}>
              ...
              <ToggleButtonGroup
                ...
                name="IsFurnished"
              >
                <ToggleButton size="small" name="IsFurnished" color="success" value="1">
                  Furnished
                </ToggleButton>
                <ToggleButton size="small" name="IsFurnished" color="info" value="2">
                  Semi-Furnished
                </ToggleButton>
                <ToggleButton size="small" name="IsFurnished" color="error" value="3">
                  Non-Furnished
                </ToggleButton>
              </ToggleButtonGroup>
          ...
          <Grid item xs={12} lg={12}>
                      <Stack spacing={1} direction="row">
                          {params.id > 0 ? <Gallery></Gallery> : <PropertyFiles setFormFiles={setFormFiles}></PropertyFiles>}
            </Stack>
          </Grid>
